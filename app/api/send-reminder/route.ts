  ...
  for (const delegate of PENDING_DELEGATES) {
    try {
      await resend.emails.send({
        from: 'NCIMUN <onboarding@resend.dev>',
        to: delegate.email,
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 2rem; color: #23272A;">
            <img src="https://ncimun2026.vercel.app/logo.png" alt="NCIMUN" style="height: 60px; margin-bottom: 1.5rem;" />
            
            <h1 style="font-size: 1.5rem; font-weight: 900; margin-bottom: 1rem;">
              Hi ${delegate.first_name}, your spot is waiting! 🎟
            </h1>

            <p style="font-size: 1rem; line-height: 1.7; color: #444; margin-bottom: 1rem;">
              You're registered for <strong>NCIMUN Summer Camp 2026</strong> but your payment hasn't been confirmed yet.
            </p>

            <p style="font-size: 1rem; line-height: 1.7; color: #444; margin-bottom: 1.5rem;">
              The <strong>Early Bird price of 2,750 EGP</strong> is expiring soon. 
              After the deadline, the price returns to <strong>3,000 EGP</strong>. 
              Don't miss out — complete your payment now to lock in your discount and secure your spot.
            </p>

            <div style="background: #F8E98D; border-radius: 10px; padding: 1rem 1.5rem; margin-bottom: 1.5rem;">
              <p style="margin: 0; font-weight: 700; font-size: .9375rem;">💳 Payment options</p>
              <p style="margin: .5rem 0 0; font-size: .9rem; color: #23272A;">
                Instapay: <a href="https://ipn.eg/S/ncimun/instapay/06DDhz" style="color: #5F96CA;">Pay via link</a><br/>
                Telda: <strong>ahmedelbaz21</strong>
              </p>
            </div>

            <a href="https://ncimun2026.vercel.app/payment-instructions?conference=summer-camp-2026" 
            ...
            <p style="font-size: .875rem; color: #888; line-height: 1.6;">
              ...
              Questions? Reply to this email or contact us at ncimun.eg@gmail.com or 010 3162 3162.
            </p>

            <hr style="border: none; border-top: 1px solid #eee; margin: 1.5rem 0;" />
            <p style="font-size: .75rem; color: #aaa;">
